...
def train(args, io):
    ...
    for epoch in range(args.epochs):
        ...
        if test_acc >= best_test_acc:
            ...
            torch.save(model.state_dict(), f'checkpoints/{args.exp_name}/model_epoch_{epoch}.pth')

        
        # torch.save(model.state_dict(), f'checkpoints/{args.exp_name}/model_epoch_{epoch}.pth')

        # Save losses and accuracies to file
        with open(f'checkpoints/{args.exp_name}/metrics.txt', 'a') as f:
    ...
    # Save final model
    torch.save(model.state_dict(), f'checkpoints/{args.exp_name}/model_final.pth')
